...
let package = Package(
    ...
    products: [
        ...
        .library(
            name: "UserSettingsRepository",
            targets: ["UserSettingsRepository"]),
    ],
    dependencies: [
        // Dependencies declare other packages that this package depends on.
		.package(url: "https://github.com/bogdanovkv/UserSettingsAbstration.git", from: "1.0.0"),
    ...
    targets: [
        ...
        .target(
            name: "UserSettingsRepository",
			dependencies: [.byName(name: "UserSettingsAbstration"),
						   .byName(name: "UserSettingsRepositoryAbstraction")]),
        .testTarget(
            name: "UserSettingsRepositoryTests",
